package quevedo.ClienteLiga.dao.cookie;
...
public class JavaCookieJar implements CookieJar {
    ...
    public void saveFromResponse(HttpUrl url, List<Cookie> cookies) {
        if (this.cookieHandler != null) {
            ...
            Map multimap = Collections.singletonMap(ConstantesCookies.SET_COOKIE, cookieStrings);

            try {
                this.cookieHandler.put(url.uri(), multimap);
            } catch (IOException var6) {
                Platform.get().log(5, ConstantesCookies.SAVING_COOKIES_FAILED_FOR + url.resolve("/..."), var6);
            }
        }
    ...
    public List<Cookie> loadForRequest(HttpUrl url) {
        ...
        try {
            ...
            Platform.get().log(5, ConstantesCookies.LOADING_COOKIES_FAILED_FOR + url.resolve("/..."), var10);
        ...
        while (true) {
            ...
            do {
                ...
                } while (!ConstantesCookies.COOKIE.equalsIgnoreCase(key) && !ConstantesCookies.COOKIE_2.equalsIgnoreCase(key));
